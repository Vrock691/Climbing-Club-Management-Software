...
<main class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/public/categories" class="btn btn-outline-secondary btn-sm">Retour aux catégories</a>
    </div>

    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-body">
            <form action="/public/search" method="get" class="row g-2">
                <div class="col-md-9">
                    <input type="text" name="nom" class="form-control" placeholder="Rechercher une sortie par nom...">
            ...
            <c:forEach items="${pageSorties.content}" var="s">
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/public/sortie/${s.id}" class="btn btn-info btn-sm text-white">Voir détails</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
